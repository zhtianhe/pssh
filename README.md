...
# 批量重启服务
pshg -W -g ncd -U User1  -c 'kall;startall'  #重启ncd组 xxx 用户下的 应用及服务          ;若已经启动则检查启动状态
pshg -W -g ncd -U USER1   -c 'startall'       #启动ncd组 USER1  用户下的应用;若已经启动则检查启动状态
pshg -W -g User-app   -c 'startall'    #启动ncd组 USER1 用户下的 UserName;若已经启动则检查启动状态
```
